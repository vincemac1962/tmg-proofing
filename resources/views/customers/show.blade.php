...
@section('content')
    ...
    <div class="grid grid-cols-8 gap-4 pt-5 w-full">
        ...
        <div class="md:col-span-2 mb-4">
            ...
            <div id="customer_country" class="col-span-4 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
        ...
        <div class="w-full md:col-span-8 mb-2">
            ...
            <div id="customer_notes" class="col-span-2 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
                {{ $customer->notes }}
            </div>
        </div>
                ...
                <table class="w-full border-collapse mt-16 mx-auto">
                    ...
                    <!-- Data Rows -->
                            @foreach($customer->proofingJobs as $job)
                                    <tr class="hover:bg-gray-100 " onclick="window.location='{{ route('proofing_jobs.show', ['proofingJob' => $job->id]) }}'">
        ...
        <div class="col-span-2 flex justify-center items-center>">
            <!-- add proofing job -->
            <a href="{{ route('proofing_jobs.create', ['customerId' => $customer->id]) }}" class="text-blue-800 hover:text-blue-600 pl-5">
                Add Proofing Job
            </a>
        </div>
        <div class="col-span-2 flex justify-center items-center">
