        ...
        <div class="grid grid-cols-4 gap-4 pt-5 w-full">
            ...
            <div class="mb-2 col-span-1">
                ...
                <input
                        ...
                        class="col-span-1 w-full  px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100"
            ...
            <div class="md:col-span-2 mb-2">
                ...
                <input
                        ...
                        id="company_name"
                        name="company_name"
                        class="w-full col-span-4 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100"
            ...
            <div class="md:col-span-2 mb-2">
                ...
                <select
                        ...
                        required
                >
                    <option value="" {{ old('customer_country') ? '' : 'selected' }}>Select Country</option>
            ...
            <div class="md:col-span-2 mb-4">
                ...
                <input
                        ...
                        id="customer_email"
                        name="customer_email"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100"
            ...
            <div class="col-span-2 mb-2">
                <label for="customer_password" class="block text-sm font-medium text-gray-700 dark:text-gray-100 mb-1">
                ...
                />
                <button type="button" onclick="openModal()" class="text-blue-600 hover:text-blue-500 dark:text-gray-100 hover:dark:text-gray-400 mt-2">
                    Generate Password
                </button>
            </div>

            <div class="col-span-2 mb-2">
                <label for="contact_number" class="block text-sm font-medium text-gray-700 dark:text-gray-100 mb-1">
                    Phone Number
                </label>
                <input
                        type="text"
            ...
            <div class="w-full md:col-span-4 mb-2">
                ...
                <textarea
                        ...
                        name="notes"
                        id="customer_notes"
                        class="text-indent-0 col-span-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100"
                >{{ old('notes') }}</textarea>
            </div>
            <!-- sixth row -->
