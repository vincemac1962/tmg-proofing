...
<div class="grid grid-cols-6 gap-4 pt-5 w-full">
    ...
    <div class="md:col-span-3 mb-2">
        ...
        <div id="address" class="col-span-1 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
    ...
    <div class="md:col-span-2 mb-2">
        ...
        <div id="telephone" class="col-span-2 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
    ...
    <!-- fourth row -->
    <div class="md:col-span-2 mb-2">
        <label for="signatory" class="block text-sm font-medium text-gray-700 mb-1">
            Signatory
        </label>
        <div id="signatory" class="col-span-2 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
            {{ $proofingCompany->email_signatory }}
        </div>
    </div>
    <div class="md:col-span-2 mb-2">
        <label for="signatory_role" class="block text-sm font-medium text-gray-700 mb-1">
            Signatory Role
        </label>
        <div id="signatory_role" class="col-span-2 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
    ...
    <div class="md:col-span-2 mb-2">
        <label for="colour_split" class="block text-sm font-medium text-gray-700 mb-1">
            Colour Split
        </label>
        <div id="colour_split" class="col-span-2 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
    ...
    <div class="md:col-span-1 mb-2">
        ...
        <div id="active" class="col-span-2 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
    ...
    <div class="col-span-2 text-center">
        <a href="{{ route('proofing_companies.index') }}" class="text-blue-800 hover:text-blue-600 pl-5">Back</a>
    </div>
    <div class="col-span-2 text-center">
        <a href="{{ route('proofing_companies.edit', $proofingCompany) }}" class="text-blue-800 hover:text-blue-600 pl-5">Edit</a>
    </div>
    <div class="col-span-2 text-center">
