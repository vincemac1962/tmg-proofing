...
@section('content')
    <x-section-heading class="border-rose-700">
        Proofing Companies - {{ isset($proofingCompany) ? 'Edit' : 'Create' }}
    </x-section-heading>
    <form method="POST" action="{{ isset($proofingCompany) ? route('proofing_companies.update', $proofingCompany) : route('proofing_companies.store') }}">
        ...
        <div class="grid grid-cols-6 gap-4 pt-5 w-full">
            ...
            <div class="md:col-span-2 mb-2">
                <label for="telephone_1" class="block text-sm font-medium text-gray-700 mb-1">
                    City
                </label>
                <input
                        type="text"
            ...
            <div class="md:col-span-2 mb-2">
                <label for="web_url" class="block text-sm font-medium text-gray-700 mb-1">
                    Web URL
                </label>
                <input
                        type="text"
            ...
            <!-- third row -->
            <div class="md:col-span-2 mb-2">
                <label for="email_signatory" class="block text-sm font-medium text-gray-700 mb-1">
                    Email Signatory
                </label>
                <input
                        type="text"
            ...
            <div class="w-full md:col-span-2 mb-2">
                <label for="company_logo_url" class="block text-sm font-medium text-gray-700 mb-1">
                    Logo URL
                </label>
                <input
                        type="text"
