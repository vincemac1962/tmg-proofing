...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold text-gray-900">Reports Maintenance</h2>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $report->report_category }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $report->report_name }}</td>
                    <td class="px-6 py-4 text-sm text-gray-900">{{ $report->report_description }}</td>
