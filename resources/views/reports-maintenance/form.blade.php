...
<div class="space-y-6">
    <div>
        <label for="report_category" class="block text-sm font-medium text-gray-700">Category</label>
    ...
    <div>
        <label for="report_name" class="block text-sm font-medium text-gray-700">Name</label>
    ...
    <div>
        <label for="report_description" class="block text-sm font-medium text-gray-700">Description</label>
