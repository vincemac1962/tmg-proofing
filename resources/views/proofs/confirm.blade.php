...
@section('content')
    ...
    <div class="grid grid-cols-6 gap-4 pt-5 w-full bg-white dark:bg-gray-800 shadow rounded-lg">
        ...
        <div class="w-full col-span-3 p-2 items-center text-center">
            <h2 class="text-xl mb-2">Do you want to send this proof to {{ $proofingJob->customer->company_name }} now?</h2>
        </div>
        ...
        <div class="col-span-3 flex">
            ...
            <div class="flex-1 flex justify-center items-center">
                <form method="POST" action="{{ route('proofs.sendProofEmail', $proof->id) }}">
                    ...
                    <button type="submit" class="text-blue-800 hover:text-blue-600">Send Email</button>
                </form>
            </div>
        </div>
    </div>
