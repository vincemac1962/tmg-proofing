...
@section('content')
    ...
    <div class="grid grid-cols-6 gap-4 pt-5 w-full bg-white dark:bg-gray-800 shadow rounded-lg">
        ...
        <div class="w-full col-span-3 p-2 items-center text-center">
            <h2 class="text-xl mb-2">Create a New Proofing Job</h2>
            <p>Fill out the form below to create a new proofing job for {{ $company_name }}.</p>
        </div>
        ...
        <div class="w-full col-span-1 py-2">
            <label for="contract_reference" class="block text-sm font-medium text-gray-700 mb-1">Contract Reference:  <span class="text-red-500">*</span></label>
            <input
                    type="text"
        ...
        <div class="w-full col-span-1 p-2">
        <label for="proofing_company_id" class="block text-sm font-medium text-gray-700 mb-1">
        ...
        <div class="w-full col-span-1 p-2">
            <label for="designer_id" class="block text-sm font-medium text-gray-700 mb-1">
        ...
        <!-- fifth row -->
        <div class="col-span-3">
            <label for="advert_location" class="block px-3 text-sm font-medium text-gray-700 mb-1">Location: <span class="text-red-500">*</span></label>
            <textarea id="advert_location"
                      name="advert_location"
                      required
                        class="text-indent-0 col-span-1 w-full px-10 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
                {{ old('advert_location') }}
            </textarea>
