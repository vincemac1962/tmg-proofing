                    ...
                    <div class="w-full md:col-span-5 mb-2">
                            <table class="w-full border-collapse mt-16 mx-auto">
                                ...
                                @foreach($activities as $activity)
                                    <tr>
                                        <td class="py-2 px-4 text-center">{{ $activity->job_id }}</td>
                                        <td class="py-2 px-4 text-center">{{ $activity->updated_at->format('d-m-Y H:i:s') }}</td>
                                        <td class="py-2 px-4 text-center">{{ $activity->user_name }}</td>
                                        <td class="py-2 px-4 text-center">{{ $activity->activity_type }}</td>
                                        <td class="py-2 px-4 text-center">{{ $activity->ip_address }}</td>
