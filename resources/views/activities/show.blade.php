...
@section('content')
    ...
    <div class="grid grid-cols-5 gap-4 pt-5 w-3/4">
        ...
        <div class="mb-2 col-span-1">
            ...
            <div id="job_id"
                 class="col-span-1 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                {{ $activity->job_id }}
            </div>
        </div>
        ...
        <div class="md:col-span-1 mb-2">
            ...
            <div id="contract_reference"
                 class="col-span-2 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100">
        ...
        <div class="mb-2 col-span-2">
            ...
            <div id="proofing_company"
                 class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100">
        ...
        @if(!empty($activity->notes))
            <div class="col-span-4">
                ...
                <div id="status"
                     class="col-span-4 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                    {{ $activity->notes }}
                </div>
            </div>
        @endif
        ...
        <div class="col-span-2 text-center">
            <a class="btn btn-primary text-blue-800 hover:text-blue-600 dark:text-gray-100 dark:hover:text-gray-400 pl-5"
        ...
        <div class="col-span-1 text-center">
            @if(Auth::check() && (int)Auth::user()->access_level >= 2)
                    <form method="POST" action="{{ route('activities.destroy', $activity) }}"
                        ...
                        @csrf
                        @method('DELETE')
                        <input type="hidden" name="proofingJob" value="{{ $activity->proofingJob->id }}">
