    ...
    <form method="POST" action="{{ route('activities.update', $activity) }}" class="w-full">
        ...
        <div class="grid grid-cols-5 gap-4 pt-5 w-3/4">
            ...
            <div class="col-span-4">
                    ...
                    <textarea name="notes" id="notes" class="w-full form-textarea p-4 text-indent-0 border border-gray-300 rounded">{{ trim($activity->notes) }}</textarea>
            ...
            <div class="col-span-2 text-center">
                <button type="submit" class="btn btn-primary text-blue-800 hover:text-blue-600">Update</button>
            </div>
