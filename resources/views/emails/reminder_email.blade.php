...
<div class="content" style="width: 80%; max-width: 80%; min-height: 50%; background-color: #F5F5F5; margin: 0 auto; padding: 20px; text-align: center; border-radius: 16px;">
    ...
    <div class="body-container">
        ...
        <div class="body-text">
            ...
            <p>I am writing to follow up on the proof we provided for your {{ $advert_location }} Advertisement.
                As we have not yet received your confirmation or any feedback, we would like to kindly remind
                you that if we do not hear from you within the next 14 days, we will consider the proof to be
                deemed correct and will proceed with the next steps.</p>

            <p>If for any reason received our email to you with the details on how to view your proof as not reached you,
                or you have lost the email, then the details for doing so are below.</p>
