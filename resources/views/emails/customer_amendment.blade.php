...
<div class="content" style="width: 80%; max-width: 80%; min-height: 50%; background-color: #F5F5F5; margin: 0 auto; padding: 20px; text-align: center; border-radius: 16px;">
        ...
        <div class="body-container">
            ...
            <div class="body-text">
                ...
                <p>Your advertisement has been amended per your instructions.</p>

                <p>To view your amended proof(s) please click on the link below and enter the username and password we've given you.
