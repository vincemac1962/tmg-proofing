...
@section('content')
    ...
    <div class="grid grid-cols-6 gap-4 pt-5 w-full">
        ...
        <div class="md:col-span-2 mb-2">
            ...
            <div id="user_name" class="col-span-2 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
                {{ $user->name }}
            </div>
        </div>
        ...
        <div class="md:col-span-2 mb-2">
            ...
            <div id="user_email" class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
                {{ $user->email }}
            </div>
        </div>
        ...
        <div class="col-span-4"></div>
        <div class="col-span-1">
            <a class="text-blue-800 hover:text-blue-600 pl-5" href="{{ route('users.index') }}">Back to Users</a>
        </div>
        <div class="col-span-1">
            <a class="text-blue-800 hover:text-blue-600 pl-5" href="{{ route('users.edit', $user->id) }}">Edit</a>
        </div>
        <div class="col-span-1">
